...
- Now click the big blue arrow, sit back & relax while it installs, if you’re curious, you can watch the mod info that pops up to get an idea of what’s being installed, you can also go to the [**Wabbajack website**](https://www.wabbajack.org) and search for this modlist in the VR section, and then **look for the Archive Search button** on the bottom left of the LoSVR panel, this lets you see the mods currently installed. **A friendly reminder:** you are downloading 400+ mods so just be patient & let it finish, if it Freezes or Fails Install (**this may happen several times during the download and install process**), simply start the process over, just re-open the LoSVR wabbajack file & click the arrow again without doing anything else & it will resume where it left off, **If you Cannot download this file whatsoever**, then **please join the** [**DVR & LoSVR Discord**](https://discord.com/invite/HuqU54gPcv) for further assistance and a mirrored link to the same file.
...
Also included is [**Ashien's Cursed Rings**](https://www.nexusmods.com/skyrim/mods/64530), these are located inside a chest near the Riverwood Trader merchant, **this mod will help your followers effectively TAKE DAMAGE at higher levels if you decide to not use NFF for this function**, so your followers are Not be god-like DMG sponges.
